...
static enum osds_option
{
    ...
    OPTOSD_JC,
    OPTOSD_FF,
    OPTOSD_FRAME_ADVANTAGE,
    OPTOSD_COMBO_COUNTER,
    OPTOSD_GRAB_BREAKOUT,
    OPTOSD_LEDGEDASH,
    OPTOSD_ACT_OO_HITSTUN,
...
static int osd_memory_bit_position[OPTOSD_MAX] = {
    0,  // Wavedash
    1,  // L-Cancel
    3,  // Act OoS Frame
    5,  // Dashback

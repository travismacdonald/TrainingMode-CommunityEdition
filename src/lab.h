...
enum cpu_option
{
    ...
    OPTCPU_CUSTOMTDI,
    OPTCPU_TECH,
    OPTCPU_TECHINPLACECHANCE,
    OPTCPU_TECHAWAYCHANCE,
    OPTCPU_TECHTOWARDCHANCE,
    OPTCPU_MISSTECHCHANCE,
    OPTCPU_GETUP,
    OPTCPU_GETUPSTANDCHANCE,
    OPTCPU_GETUPAWAYCHANCE,
    OPTCPU_GETUPTOWARDCHANCE,
    OPTCPU_GETUPATTACKCHANCE,
    OPTCPU_MASH,
    //OPTCPU_RESET,
    OPTCPU_CTRGRND,
    OPTCPU_CTRAIR,
